...
//dodawanie wiersza z elementami  do tabeli
	...
	echo '			<td class="opisUbId"> <select name = "opisUbId">';
					...
					echo '	<td class="opisUbIlosc"><input min="1" step="1" max="99" type="number" name="ubrIlosc" /></td>
							<td class="opisUbCzas"><input min="1" step="1" max="99" type="number" name="ubrCzas" /></td>
							<td>X</td>
